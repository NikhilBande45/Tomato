    ...
    <form className='place-order' onSubmit={placeOrder}>
        <div className="place-order-left">
          ...
          <div className="multi-fields">
            <input required onChange={onChangeHandler} name="firstName" value={data.firstName} placeholder="First Name"/>
            <input required onChange={onChangeHandler} name="lastName" value={data.lastName} type="text" placeholder="Last Name"/>
          </div>
          <input required onChange={onChangeHandler} name="email" value={data.email} type="email" placeholder='Enter E-mail' />
          ...
          <input required onChange={onChangeHandler} name="phone" value={data.phone} type="test" placeholder="Phone" />
        </div>
